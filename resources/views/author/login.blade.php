...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <form method="post" action="{{ route('author.do.login') }}">
        ...
        @endif
          ...
          <div class="mb-3 form-check">
            <input type="checkbox" class="form-check-input" name="rememberToken">
            <label class="form-check-label" for="exampleCheck1">Remember Password</label>
          </div>
          <button type="submit" class="btn btn-primary" style="margin-right: 10px">Submit</button>
          <a href="{{route('author.signup')}}" >I don't have Account</a>
        </form>
  </div>
