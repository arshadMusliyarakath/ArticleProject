      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">{{auth()->guard('author')->user()->name}}</span>
...
<style>
#sidebar .nav-item.active .nav-link.collapsed, #sidebar .nav-item.active i{
  color: #4154f1;
  background: #f6f9ff;
}
</style>
